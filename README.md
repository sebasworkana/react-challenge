...
9. Use github pages to host web app and test [Page] (https://felparodi.github.io/wk-react-coding-challege/)
...
To work in this react app using docker only need to run the next script to up the modules
